...
typedef enum {
    HY_AUDIO_RECORDER_BIT_S8 = 1,
    HY_AUDIO_RECORDER_BIT_S16_LE = 0,
    HY_AUDIO_RECORDER_BIT_S16_BE = 2,
    HY_AUDIO_RECORDER_BIT_S24_LE,
    HY_AUDIO_RECORDER_BIT_S24_BE,
    HY_AUDIO_RECORDER_BIT_S24_3LE,
    HY_AUDIO_RECORDER_BIT_S24_3BE,
    HY_AUDIO_RECORDER_BIT_S32_LE,
    HY_AUDIO_RECORDER_BIT_S32_BE,

    HY_AUDIO_RECORDER_BIT_MAX
} HyAudioRecorderBit_e;
